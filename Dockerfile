...
COPY ./internal/container/media/ ${DIRPATH}/internal/media/
COPY ./internal/container/scripts/ ${DIRPATH}/internal/scripts/
COPY ./internal/container/style/ ${DIRPATH}/internal/style/
